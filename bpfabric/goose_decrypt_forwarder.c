...
// Handle traffic entering and returning from the user-space decryption path
...
// Redirect matching protected GOOSE traffic from the physical network towards the decryption TAP path
